...
import net.antlersofthewinter.procedures.SnowwalkerEntityIsHurtProcedure;
import net.antlersofthewinter.init.AntlersOfTheWinterModEntities;

public class SnowwalkerEntity extends Zombie {
	public SnowwalkerEntity(EntityType<SnowwalkerEntity> type, Level world) {
		super(type, world);
		xpReward = 5;
		setNoAi(false);
	}
	...
	public SoundEvent getAmbientSound() {
		return BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("entity.stray.ambient"));
	}
	...
	public boolean hurt(DamageSource damagesource, float amount) {
		...
		if (!SnowwalkerEntityIsHurtProcedure.execute(damagesource, entity))
			return false;
	...
	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(AntlersOfTheWinterModEntities.SNOWWALKER.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
